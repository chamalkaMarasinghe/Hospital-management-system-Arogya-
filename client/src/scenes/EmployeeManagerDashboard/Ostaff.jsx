...
function Ostaff() {
  ...
  const loadData = async() => {
    const req = await fetch("http://localhost:3001/Employee/getSpecificCategory/Other Staff", {
      method : "GET",
    })
    const res = req.json()
    return res
  ...
  useEffect(() => {
    ...
    return (
       <>
         ...
         <div><A_navbar/></div>
        <hr style={{height:'100px'}}></hr><div><h1 className='topic'>Other Staff List</h1></div>
